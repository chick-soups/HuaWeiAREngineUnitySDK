...
//
// 摘要:
//     Enumeration describing the AR rendering mode used with XR.ARBackgroundRenderer.
public enum ARRenderMode
{
    ...
    //
    // 摘要:
    //     The material associated with XR.ARBackgroundRenderer is being rendered as the
    //     background.
...
public class ARBackgroundRenderer {
    ...
    public ARBackgroundRenderer(Camera seeThroughCamera, Material backgroundMaterial) {
